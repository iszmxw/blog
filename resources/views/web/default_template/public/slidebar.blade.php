                ...
                <ul class="list-group">
                    @foreach($sort as $key=>$val)
                        <li class="list-group-item">
                            <span class="badge badge-primary">{{ $val['count'] }}</span> <a href="{{ url('category').'/'.$val['id'] }}" target="_blank" style="color:#000;">
                                {{ $val['name'] }}
                            </a>
                        </li>
                    @endforeach
                ...
                <div class="feed-activity-list">
                    @foreach($comments as $key=>$val)
                        <div class="feed-element">
                            <a href="javascript:;" class="pull-left"> <img alt="image" class="img-circle" src="http://q1.qlogo.cn/g?b=qq&nk={{ $val['mail'] }}&s=640"> </a>
                            <div class="media-body ">
                                <small class="pull-right">{{ date('Y-m-m H:i:s',$val['created_at']) }}</small>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>站点统计</h5>
                <div class="ibox-tools">
                        <span class="label label-primary-light pull-right">
                            <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? "https://" : "http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1276750286'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s96.cnzz.com/z_stat.php%3Fid%3D1276750286%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
                        </span>
                </div>
            </div>
            <div class="ibox-content no-padding">
                <ul class="list-group">
                    <li class="list-group-item">
                        文章总数： <span class="label label-info">{{ $site_info['blogs'] }}篇</span>
                    </li>
                    <li class="list-group-item">
                        微语总数： <span class="label label-primary">{{ $site_info['twitters'] }}条</span>
                    </li>
                    <li class="list-group-item">
                        评论总数： <span class="label label-success">{{ $site_info['comments'] }}条</span>
                    </li>
                    <li class="list-group-item">
                        运行天数: <span class="label label-danger">{{ $site_info['naissance'] }}天</span>
                    </li>
                </ul>
            </div>
        </div>
